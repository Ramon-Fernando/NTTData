package br.com.ramon.hangman.model;

import br.com.ramon.hangman.exception.GameIsFinishedException;
import br.com.ramon.hangman.exception.LetterAlreadyInputtedException;

import java.util.ArrayList;
import java.util.List;
import java.util.stream.Stream;

import static br.com.ramon.hangman.model.HangmanGameStatus.*;

public class HangmanGame {

    private final static int HANGMAN_INITIAL_LINE_LENGTH = 9;
    private final static int HANGMAN_INITIAL_LINE_LENGTH_WHITE_LINE_SEPARATOR = 10;
    ...
    public HangmanGame(final List<HangmanChar> characters) {
        ...
        this.lineSize = HANGMAN_INITIAL_LINE_LENGTH_WHITE_LINE_SEPARATOR + whiteSpaces.length();
